    ...
    const handleDeleteProduct = id =>{
        ...
        .then(data =>{
            ...
            if(data.deletedCount > 0){
                ...
                let remainingProducts = products.filter(product => product._id !== id);
                ...
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        ...
                        {products.map((product) => (
                            ...
                            <TableCell width="20%" align="center"><img src={product.image} alt="product" width="45%" /></TableCell>
                            ...
                            <TableCell align="center">
                                <IconButton onClick={()=> handleDeleteProduct(product._id)} color="secondary" aria-label="delete">
                                    <DeleteIcon />
                                </IconButton>
                            </TableCell>
