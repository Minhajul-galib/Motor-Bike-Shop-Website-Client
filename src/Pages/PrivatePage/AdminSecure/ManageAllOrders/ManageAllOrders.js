                ...
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                        ...
                        {orders.map((order) => (
                            ...
                            <TableCell width="20%" align="center"><img src={order.orderImage} alt="product" width="45%" /></TableCell>
                            ...
                            <TableCell align="center">
                                <IconButton onClick={()=> handleDeleteProduct(order._id)} color="secondary" aria-label="delete">
                                    <DeleteIcon />
                                </IconButton>
                            </TableCell>
